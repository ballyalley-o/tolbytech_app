const products = [
  ...
  description: 'Introducing Google Home Mini - a smart speaker with the Google Assistant built-in. It can answer questions, play music, and control smart devices in your home.',
  brand: 'Google',
  category: 'Electronics',
  price: 29.99,
  countInStock: 5,
  ...
  description: 'The iPhone 12 Pro features a stunning design and advanced camera system. It comes with a Super Retina XDR display and is powered by the A14 Bionic chip.',
  brand: 'Apple',
  category: 'Electronics',
  price: 999.99,
  countInStock: 5,
...
},
{
  ...
  description: 'Experience the ultimate in smartphone technology with the Samsung Galaxy S21 Ultra. It boasts a large Dynamic AMOLED 2X display and a powerful Exynos 2100 processor.',
  brand: 'Samsung',
  category: 'Electronics',
  price: 1199.99,
  countInStock: 3,
...
},
{
  ...
  description: 'Get ready for the next generation of gaming with the Sony PlayStation 5. It features ultra-fast loading times, ray tracing, and an immersive DualSense controller.',
  brand: 'Sony',
  category: 'Electronics',
  price: 499.99,
  countInStock: 2,
...
},
{
  ...
  description: 'The Apple MacBook Pro is a high-performance laptop with a sleek design. It offers a brilliant Retina display, a fast processor, and a spacious storage capacity.',
  brand: 'Apple',
  category: 'Electronics',
  price: 1999.99,
  countInStock: 10,
